...
void Scanner::setDiagnosticsEngine(const std::shared_ptr<JAPCDiagnostics> &diagnosticsEngine)
{
    Scanner::diagnosticsEngine = diagnosticsEngine;
}
